/*
环境变量：
1、token： gua_kuanggong_token
2、白名单： gua_kuanggong_whitelist用&隔开 pin值(填中文)
3、黑名单： gua_kuanggong_blacklist同上
4、是否发送消息： gua_kuanggong_sendNotifyStatus默认 true｜true 为发送 false 不发送

使用说明：
白名单：
当填写白名单时，按白名单上的顺序当车头，如果白名单不在cookie中，则退出脚本
黑名单：
在黑名单中的cookie不会参与助力

gua_kuanggong_token
roejeiwo7hil6f2iq6qapj5shly1gbvkjn9d
